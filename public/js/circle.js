...
var svg = d3.select("div#circle-container")
  // .append("div")
  .append("svg")
  .classed("svg-content", true)
  .classed("svg-content-responsive", true)
  .attr("preserveAspectRatio", "xMinYMin meet")
  .attr("viewBox", "-250 0 2000 2000")
    // .attr("width", "100%")
    // .attr("height", "900px")
  .append("g")
    .attr("transform", "translate(" + width / 2 + ", 1000)"); // up-down
...
var tooltip=d3.select("#circle-container").append("div")
    .attr("class","tooltip")
    .style("opacity",1e-6)
